...
// the caller.
type BlockUnmarshaler func(bz []byte) (BlockData, error)
...
func (b *blockStore) AddBlock(block BlockData) {
...
func (b *blockStore) UpdateLabel(label eth.BlockLabel, hash Hash) error {
...
func (b *blockStore) BlockByHash(hash Hash) BlockData {
...
func (b *blockStore) BlockByNumber(height int64) BlockData {
...
func (b *blockStore) BlockByLabel(label eth.BlockLabel) BlockData {
